...
export default function MIDCNIT22() {
    ...
    document.addEventListener("adobe_dc_view_sdk.ready", function () {
      const adobeDCView = new window.AdobeDC.View({ clientId: randomizedClientIds[0], divId: "adobe-dc-view" });
        adobeDCView.previewFile({
          content: { location: { url: "https://cu-studentcorner.in/csit/first/midcnit22.pdf" } },
          metaData: { fileName: "midcnit22.pdf" }
        }, previewConfig );
      });
    };
  ...
  return (
    <div>
        <h2 id="title">Computer Network and Internet Technologies (2022)</h2>
