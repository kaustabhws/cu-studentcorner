...
export default function ENDPF21() {
    ...
    document.addEventListener("adobe_dc_view_sdk.ready", function () {
      const adobeDCView = new window.AdobeDC.View({ clientId: randomizedClientIds[0], divId: "adobe-dc-view" });
        adobeDCView.previewFile({
          content: { location: { url: "https://cu-studentcorner.in/csit/first/endpf21.pdf" } },
          metaData: { fileName: "endpf21.pdf" }
        }, previewConfig );
      });
    };
  ...
  return (
    <div>
        <h2 id="title">Programming Fundamentals using C/C++ (2021)</h2>
